...
const BybitSimpleTracker = require('./bybit-simple-tracker');
...
app.listen(port, () => {
    console.log('🚀 BYBIT TRACKER DZIAŁA: http://localhost:' + port);
    console.log('✅ TIMEFRAME: 1m, 5m, 15m, 30m, 1h');
    console.log('✅ TYLKO AKTUALNE DANE - BEZ HISTORII');
});
